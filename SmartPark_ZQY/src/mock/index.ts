...
Mock.mock('https://api.smartpark.com/login', 'post', (options: RequestInit) => {
...
Mock.mock('https://api.smartpark.com/menu', 'get', () => {
...
Mock.mock('https://api.smartpark.com/energyData', 'get', () => {
  return {
    code: 200,
    message: '请求成功',
    data: [
...
Mock.mock('https://api.smartpark.com/userList', 'post', (options: RequestInit) => {
...
Mock.mock('https://api.smartpark.com/deleteUser', 'post', (options: RequestInit) => {
...
Mock.mock(
  'https://api.smartpark.com/batchDeleteUser',
  'post',
  (options: RequestInit) => {
    ...
    return {
      code: 200,
      message: '成功', 'data': '操作成功',
    };
  }
);

Mock.mock('https://api.smartpark.com/editUser', 'post', (options: RequestInit) => {
  console.log('编辑企业收到参数', JSON.parse(options.body as string));
  return {
    code: 200,
    message: '成功',
    data: '操作成功',
...
Mock.mock('https://api.smartpark.com/roomList', 'post', (options: RequestInit) => {
  console.log('收到房间id', JSON.parse(options.body as string).roomid);
  return {
    code: 200,
    message: '成功',
    data: {
...
Mock.mock(
  'https://api.smartpark.com/contractList',
  'post',
  (options: RequestInit) => {
    const { page, pageSize } = JSON.parse(options.body as string);
    console.log('后端合同管理接到参数', JSON.parse(options.body as string));
    return {
      code: 200,
      message: '成功',
      data: Mock.mock({
...
Mock.mock('https://api.smartpark.com/billList', 'post', (options: RequestInit) => {
  const { page, pageSize, companyName, contact, phone } = JSON.parse(
    options.body as string
  );
  console.log('后端账单管理接到参数', JSON.parse(options.body as string));
  return {
    code: 200,
    message: '成功',
    data: Mock.mock({
...
Mock.mock(
  'https://api.smartpark.com/accountList',
  'post',
  (options: RequestInit) => {
...
Mock.mock('https://api.smartpark.com/equipmentList', 'post', (options: RequestInit) => {
  const { page, pageSize, name, person } = JSON.parse(options.body as string);
  console.log('后端设备管理接到参数', page, pageSize, name, person);
  return {
    code: 200,
    message: '成功',
    data: Mock.mock({
