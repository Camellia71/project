...
//登录接口
Mock.mock('https://www.demo.com/login', 'post', (options: RequestInit) => {
...
Mock.Random.extend({
  phone: function () {
    const phonePrefixs = ['13', '14', '15', '16', '17', '18', '19']; // 自己写前缀哈
    return this.pick(phonePrefixs) + Mock.mock(/\d{9}/); //Number()
  },
});

//租户列表的接口
Mock.mock('https://www.demo.com/userList', 'post', (options: RequestInit) => {
...
//删除企业
Mock.mock('https://www.demo.com/deleteUser', 'post', (options: RequestInit) => {
...
//批量删除企业
Mock.mock(
  'https://www.demo.com/batchDeleteUser',
  'post',
  (options: RequestInit) => {
...
//编辑企业
Mock.mock('https://www.demo.com/editUser', 'post', (options: RequestInit) => {
...
Mock.mock('https://www.demo.com/roomList', 'post', (options: RequestInit) => {
...
//合同管理
Mock.mock(
  'https://www.demo.com/contractList',
  'post',
  (options: RequestInit) => {
...
//账单管理
Mock.mock('https://www.demo.com/billList', 'post', (options: RequestInit) => {
...
//账号管理
Mock.mock(
  'https://www.demo.com/accountList',
  'post',
  (options: RequestInit) => {
    //  const {page,pageSize,companyName,contact,phone}=JSON.parse(options.body as string);
