...
**位置**: `public/fonts/plus-jakarta-sans/`

**字体文件清单**:

| 文件名 | 格式 | 字重 | 用途 |
|--------|------|------|------|
| PlusJakartaSans-Regular.ttf | TTF | 400 | 常规 |
...
| PlusJakartaSans-Bold.ttf | TTF | 700 | 粗体 |

**SCSS 定义** (`src/app/globals.scss`):
...
@font-face {
  ...
  src: url('/fonts/plus-jakarta-sans/PlusJakartaSans-SemiBold.woff') format('woff'),
       url('/fonts/plus-jakarta-sans/PlusJakartaSans-SemiBold.ttf') format('truetype');
  font-weight: 600;
  font-style: normal;
  font-display: swap;
}
...
<link
  rel="preload"
  href="/fonts/plus-jakarta-sans/PlusJakartaSans-Regular.woff"
  as="font"
  type="font/woff"
  crossorigin
/>
